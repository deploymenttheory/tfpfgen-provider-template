...
| `TFPFGEN_PROBE_API_URL` | probe job | the API's base URL |
| `TFPFGEN_PROBE_SANDBOX_REASON` | probe job | a sentence (≥ 4 words) stating why this tenant is disposable |
| `TFPFGEN_PROBE_ACCOUNT_SCOPE_ID` | probe job | the tenant scope the probe stays inside |
